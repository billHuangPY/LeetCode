    ...
    def sumNumbers(self, root):
        ...
        def getSum(sub_root, sub_str):
            if not sub_root:
                ...
                return getSum(
                    sub_root.left, sub_str + str(sub_root.val)
                ) + getSum(sub_root.right, sub_str + str(sub_root.val))
    ...
    def sumNumbers(self, root):
        ...
        def getSum(sub_root, sub_num):
            if not sub_root:
                ...
                return getSum(
                    sub_root.left, sub_num * 10 + sub_root.val
                ) + getSum(sub_root.right, sub_num * 10 + sub_root.val)
